...
public class Driver {
    ...
    private static final String QUERY_MICHAEL = "Query 5: Find the name of each instructor who teaches a section that is located in the building of the department the instructor belongs to, as well as which section that is (course and section IDs, year, and seemster) and what building it is in.";
